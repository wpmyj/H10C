...
*****************************************************************************************/
		...
		#define TIMER_DIV12_VALUE_10us			65536-9     //9*12/11.0592 = 10 uS,  Timer Clock = Fsys/12
		#define TIMER_DIV12_VALUE_1ms				65536-923   //923*12/11.0592 = 1 mS, Timer Clock = Fsys/12
		#define TIMER_DIV4_VALUE_10us				65536-28    //28*4/11.0592 = 10 uS,  Timer Clock = Fsys/4
		#define TIMER_DIV4_VALUE_1ms				65536-2765  //2765*4/11.0592 = 1 mS, Timer Clock = Fsys/4
#endif
#ifdef FOSC_160000		// if Fsys = 16MHz 
		#define TIMER_DIV12_VALUE_10us			65536-13				//13*12/16000000 = 10 uS,  			// Timer divider = 12
		...
		#define TIMER_DIV4_VALUE_10us				65536-40				//40*4/16000000 = 10 uS,    		// Timer divider = 4
